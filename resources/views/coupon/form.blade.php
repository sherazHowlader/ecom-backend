...
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div style="font-variant: small-caps"> <b> Add Coupon </b> </div>
        </div>
                ...
                <form class="needs-validation" action="{{route('coupon.store')}}" method="POST" novalidate>
                    ...
                    <div class="offset-md-3 col-md-6">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Exm: Rt22Vc" name="coupon_name">
                        </div>
                    </div>
                    <div class="offset-md-3 col-md-6">
                        <div class="input-group mb-3">
                            <span class="input-group-text" id="basic-addon3">Discount</span>
                            <input type="text" class="form-control" placeholder="Exm: 20%" name="discount">
                        </div>
